...
#define POD_STYLES list(\
    ...
    list("centcompod", "\improper Centcom supply pod", "A Nanotrasen supply pod, this one has been marked with Monkey Central Command's designations. Teleports back to Centcom after delivery."),\
