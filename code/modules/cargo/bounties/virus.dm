...
/datum/bounty/virus/New()
	...
	description = "Nanotrasen is interested in a virus with a [stat_name] stat of exactly [stat_value]. Monkey Central Command will pay handsomely for such a virus."
	reward += rand(0, 4) * 500
