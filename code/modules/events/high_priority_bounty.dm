...
/datum/round_event/high_priority_bounty/announce(fake)
	priority_announce("Monkey Central Command has issued a high-priority cargo bounty. Details have been sent to all bounty consoles.", "Nanotrasen Bounty Program")
